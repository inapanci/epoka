# -*- coding: utf-8 -*-
"""frcnn_train_vgg_ip.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/11aVp2JZ24aC2lnGQ_DLPHsXmkCnCGYly
"""
...
class Config:
    ...
    # Original anchor_box_scales in the paper is [128, 256, 512]
		self.anchor_box_scales = [64, 128, 256] #previously: [64, 128, 256] [32, 64, 128]
...
def classifier_layer(base_layers, input_rois, num_rois, nb_classes = 4):
    ...
    out = TimeDistributed(Dropout(0.2))(out) #Dropout(0.5)
...
base_path = '/content/drive/My Drive/frcnn'

train_path = '/content/drive/My Drive/frcnn/train_labels.csv'
...
output_weight_path = os.path.join(base_path, 'model03/model_frcnn_vgg.hdf5')

record_path = os.path.join(base_path, 'model03/record.csv') # Record data (used to save the losses, classification accuracy and mean average precision)

base_weight_path = os.path.join(base_path, 'model03/vgg16_weights_tf_dim_ordering_tf_kernels.h5')

config_output_filename = os.path.join(base_path, 'model03/vgg_config.pickle')
...
if debug_num_pos==0:
    ...
    for i in range(debug_num_pos):
        ...
        anchor_size = C.anchor_box_scales[int(idx/4)] #anchor_size = C.anchor_box_scales[int(idx/4)]
